...
dict1 = {"Annual_Deposit_Amount" : 38304, "Home_value" : 29614, "Years_with_the_bank" : 3, "Loan_held" : 1, 
         "Wealth_portfolio_held" : 1, "Automated_menu" : 3}
#2. Convert to an array of shape (1,6) lets call it 'arr'
arr= list(dict1.values())
arr= np.array(arr).reshape(1,6).astype(np.float64)

#3. Scale the array using Scaler.pkl
scaler = joblib.load('Scaler.pkl') 
data_point = scaler.transform(arr)

#4. Get predictions loading 
